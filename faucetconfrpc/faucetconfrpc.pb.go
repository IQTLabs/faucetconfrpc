...
var file_protos_faucetconfrpc_faucetconfrpc_proto_rawDesc = []byte{
	...
	0x74, 0x41, 0x63, 0x6c, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x14, 0x5a, 0x12, 0x2e,
...
func file_protos_faucetconfrpc_faucetconfrpc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protos_faucetconfrpc_faucetconfrpc_proto_msgTypes[43].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protos_faucetconfrpc_faucetconfrpc_proto_msgTypes[44].Exporter = func(v interface{}, i int) interface{} {
...
func (c *faucetConfServerClient) SetVlanOutAcl(ctx context.Context, in *SetVlanOutAclRequest, opts ...grpc.CallOption) (*SetVlanOutAclReply, error) {
	...
	err := c.cc.Invoke(ctx, "/faucetconfserver.FaucetConfServer/SetVlanOutAcl", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _FaucetConfServer_SetVlanOutAcl_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/faucetconfserver.FaucetConfServer/SetVlanOutAcl",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
