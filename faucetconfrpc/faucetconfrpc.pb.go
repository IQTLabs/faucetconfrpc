...
var file_protos_faucetconfrpc_faucetconfrpc_proto_rawDesc = []byte{
	...
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x03, 0x64, 0x70, 0x73, 0x32, 0xd9, 0x07, 0x0a, 0x10, 0x46, 0x61,
	...
	,
}
...
var file_protos_faucetconfrpc_faucetconfrpc_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
...
var file_protos_faucetconfrpc_faucetconfrpc_proto_depIdxs = []int32{
	...
	0,  // 4: faucetconfserver.FaucetConfServer.GetConfigFile:input_type -> faucetconfserver.GetConfigFileRequest
	2,  // 5: faucetconfserver.FaucetConfServer.SetConfigFile:input_type -> faucetconfserver.SetConfigFileRequest
	4,  // 6: faucetconfserver.FaucetConfServer.DelConfigFromFile:input_type -> faucetconfserver.DelConfigFromFileRequest
	6,  // 7: faucetconfserver.FaucetConfServer.AddPortMirror:input_type -> faucetconfserver.AddPortMirrorRequest
	8,  // 8: faucetconfserver.FaucetConfServer.RemovePortMirror:input_type -> faucetconfserver.RemovePortMirrorRequest
	12, // 9: faucetconfserver.FaucetConfServer.AddPortAcl:input_type -> faucetconfserver.AddPortAclRequest
	14, // 10: faucetconfserver.FaucetConfServer.RemovePortAcl:input_type -> faucetconfserver.RemovePortAclRequest
	10, // 11: faucetconfserver.FaucetConfServer.SetPortAcl:input_type -> faucetconfserver.SetPortAclRequest
	18, // 12: faucetconfserver.FaucetConfServer.SetDpInterfaces:input_type -> faucetconfserver.SetDpInterfacesRequest
	20, // 13: faucetconfserver.FaucetConfServer.GetDpInfo:input_type -> faucetconfserver.GetDpInfoRequest
	1,  // 14: faucetconfserver.FaucetConfServer.GetConfigFile:output_type -> faucetconfserver.GetConfigFileReply
	3,  // 15: faucetconfserver.FaucetConfServer.SetConfigFile:output_type -> faucetconfserver.SetConfigFileReply
	5,  // 16: faucetconfserver.FaucetConfServer.DelConfigFromFile:output_type -> faucetconfserver.DelConfigFromFileReply
	7,  // 17: faucetconfserver.FaucetConfServer.AddPortMirror:output_type -> faucetconfserver.AddPortMirrorReply
	9,  // 18: faucetconfserver.FaucetConfServer.RemovePortMirror:output_type -> faucetconfserver.RemovePortMirrorReply
	13, // 19: faucetconfserver.FaucetConfServer.AddPortAcl:output_type -> faucetconfserver.AddPortAclReply
	15, // 20: faucetconfserver.FaucetConfServer.RemovePortAcl:output_type -> faucetconfserver.RemovePortAclReply
	11, // 21: faucetconfserver.FaucetConfServer.SetPortAcl:output_type -> faucetconfserver.SetPortAclReply
	19, // 22: faucetconfserver.FaucetConfServer.SetDpInterfaces:output_type -> faucetconfserver.SetDpInterfacesReply
	23, // 23: faucetconfserver.FaucetConfServer.GetDpInfo:output_type -> faucetconfserver.GetDpInfoReply
